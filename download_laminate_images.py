...
with open('source_laminate.html', 'r', encoding='utf-8') as f:
    content = f.read()

# Capture all Wix media URLs
...
ignored = [
    ...
    "e66ac7_8b72941613c44f84907bd409a2efe7a3",
    "e66ac7_95e9bd6fa15a4d94b5b5cf1bbc4f60fc", 
]

for img in images:
    if not any(ig in img for ig in ignored) and any(ext in img for ext in ['.jpg', '.png', '.webp']):
        # Clean params if any (Wix standard)
